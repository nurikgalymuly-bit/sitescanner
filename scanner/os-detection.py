...
def osScan(targets, out_xml):
    ...
    nmap_cmd = f"/usr/bin/nmap --privileged {targets} -n -Pn -O -T5 --min-parallelism 300 --min-rate 1000 --max-retries 1 --host-timeout 60s -vv -oX {out_xml}"
...
def main():
    ...
    osScan(target, '/home/cherry/Документы/sitescanner/reports/Stage_1')
