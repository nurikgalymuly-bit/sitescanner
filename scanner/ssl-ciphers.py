...
def main():
    in_xml = '/home/cherry/Документы/sitescanner/reports/Stage_2/top_1000_portscan.xml'
    ...
    for target in targets:
        ...
        sslCipherScan(target_ip, target_ports, '/home/cherry/Документы/sitescanner/reports/Stage_2')
